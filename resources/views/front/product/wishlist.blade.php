                        ...
                        <tr class="product-action-row">
                            <td colspan="4" class="clearfix">
                                ...
                                <div class="float-right">
                                    <a href="{{ route('wishlist.delete',$wishlist->id) }}" onclick="return confirm('Are you confirm to remove this Product from Cart?')" title="Remove product" class="btn-remove"><span class="sr-only">Remove</span></a>
                                </div><!-- End .float-right -->
                            </td>
                        </tr>
                         @php
