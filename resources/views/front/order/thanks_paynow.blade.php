        ...
        <div class="row vertical-center-row">
            ...
            <div class="col-md-6 order-lg-last dashboard-content">
                ...
                <div class="alert alert-info" align="center">
                    ...
                    <h5>Thanks for the payment. We will process your order very soon</h5>
                    <h5>Your order number is {{ Session::get('order_id') }} and total amount paid is ৳ {{ Session::get('grand_total') }}/-</h5>
                </div>
