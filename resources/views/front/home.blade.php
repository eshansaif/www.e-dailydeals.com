        ...
        <div class="container">
            ...
            <div class="featured-products owl-carousel owl-theme">
                <div class="product">
                    <figure class="product-image-container">
                        <a href="product.html" class="product-image">
                            <img src="{{ asset('assets/frontend/assets/images/products/product-10-white.jpg') }}" alt="product">
                        </a>
                ...
                <div class="product">
                    <figure class="product-image-container">
                        <a href="product.html" class="product-image">
                            <img src="{{ asset('assets/frontend/assets/images/products/product-3-white.jpg') }}" alt="product">
                        </a>
                        <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                    </figure>
                    <div class="product-details">
                ...
                <div class="product">
                    <figure class="product-image-container">
                        <a href="product.html" class="product-image">
                            <img src="{{ asset('assets/frontend/assets/images/products/product-13-white.jpg') }}" alt="product">
                        </a>
                        <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                    </figure>
                    <div class="product-details">
                ...
                <div class="product">
                    <figure class="product-image-container">
                        <a href="product.html" class="product-image">
                            <img src="{{ asset('assets/frontend/assets/images/products/product-2-white.jpg') }}" alt="product">
                        </a>
                        <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                    </figure>
                    <div class="product-details">
                ...
                <div class="product">
                    <figure class="product-image-container">
                        <a href="product.html" class="product-image">
                            <img src="{{ asset('assets/frontend/assets/images/products/product-8-white.jpg') }}" alt="product">
                        </a>
                        <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                    </figure>
                    <div class="product-details">
                ...
                <div class="product">
                    <figure class="product-image-container">
                        <a href="product.html" class="product-image">
                            <img src="{{ asset('assets/frontend/assets/images/products/product-1-white.jpg') }}" alt="product">
                        </a>
                        <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                    </figure>
                    <div class="product-details">
        ...
        <div class="container">
            ...
            <div class="new-products owl-carousel owl-theme">
                <div class="product">
                    <figure class="product-image-container">
                        <a href="product.html" class="product-image">
                            <img src="{{ asset('assets/frontend/assets/images/products/product-10.jpg') }}" alt="product">
                        </a>
                        <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                    </figure>
                    <div class="product-details">
                ...
                <div class="product">
                    <figure class="product-image-container">
                        <a href="product.html" class="product-image">
                            <img src="{{ asset('assets/frontend/assets/images/products/product-6.jpg') }}" alt="product">
                        </a>
                        <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                    </figure>
                    <div class="product-details">
                ...
                <div class="product">
                    <figure class="product-image-container">
                        <a href="product.html" class="product-image">
                            <img src="{{ asset('assets/frontend/assets/images/products/product-13.jpg') }}" alt="product">
                        </a>
                        <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                    </figure>
                    <div class="product-details">
                ...
                <div class="product">
                    <figure class="product-image-container">
                        <a href="product.html" class="product-image">
                            <img src="{{ asset('assets/frontend/assets/images/products/product-14.jpg') }}" alt="product">
                        </a>
                        <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                    </figure>
                    <div class="product-details">
