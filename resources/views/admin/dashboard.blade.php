...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <!--sidebar nav start-->
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="menu-list nav-active"><a href="index-2.html"><i class="fa fa-home"></i> <span>Dashboard</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="index_alt.html"> Dashboard 1</a></li>
                        <li class="active"><a href="index-2.html"> Dashboard 2</a></li>
                    </ul>
                </li>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="wdgt-profile">
                        <div class="profile">
                            <img src="{{asset('assets/backend/images/gallery/wdgt-img.jpg')}}" alt=""/>
                ...
                <div class="col-md-4">
                    <div class="panel widget-info-one">
                        <div class="avatar-img">
                            <img src="{{asset('assets/backend/images/gallery/image3.jpg')}}" alt=""/>
                        </div>
                        <div class="inner">
                            <div class="avatar"><img alt="" src="{{asset('assets/backend/images/photos/userprofile.png')}}"></div>
                            <h5>Margarita Rose</h5>
                            <span class="subtitle">
                        ...
                        <div class="panel-body">
                            <div class="dir-info">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <div class="avatar">
                                            <img src="{{asset('assets/backend/images/photos/user2.png')}}" alt=""/>
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                        <h5>Wild Awake</h5>
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        <div class="avatar">
                                            <img src="{{asset('assets/backend/images/photos/user1.png')}}" alt=""/>
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                        <h5>Bulet Proof</h5>
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        <div class="avatar">
                                            <img src="{{asset('assets/backend/images/photos/user3.png')}}" alt=""/>
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                        <h5>Bit it</h5>
                                ...
                                <div class="row">
                                    <div class="col-xs-3">
                                        <div class="avatar">
                                            <img src="{{asset('assets/backend/images/photos/user4.png')}}" alt=""/>
                                        </div>
                                    </div>
                                    <div class="col-xs-6">
                                        <h5>Its my life</h5>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <ul class="chats cool-chat">
                                <li class="in">
                                    <img src="{{asset('assets/backend/images/photos/user1.png')}}" alt="" class="avatar">
                                    <div class="message">
                                ...
                                <li class="out">
                                    <img src="{{asset('assets/backend/images/photos/user2.png')}}" alt="" class="avatar">
                                    <div class="message">
                                        <span class="arrow"></span>
                        ...
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="#" class="pull-left">
                                    <img class="thumb" src="{{asset('assets/backend/images/photos/user2.png')}}" alt=""/>
                                </a>
                                <div class="media-body">
...
<!--Sparkline Chart-->
<script src="{{asset('assets/backend/js/sparkline/jquery.sparkline.js')}}"></script>
<script src="{{asset('assets/backend/js/sparkline/sparkline-init.js')}}"></script>
...
<script src="{{asset('assets/backend/js/flot-chart/jquery.flot.resize.js')}}"></script>
<script src="{{asset('assets/backend/js/flot-chart/jquery.flot.pie.resize.js')}}"></script>
<script src="{{asset('assets/backend/js/flot-chart/jquery.flot.selection.js')}}"></script>
