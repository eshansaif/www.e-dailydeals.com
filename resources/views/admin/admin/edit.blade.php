                            ...
                            <form action="{{ route('admin.update', $admin->id) }}" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <input name="type" value="{{ old('type', isset($admin)?$admin->type:null) }}" type="text" class="form-control form-control-line @error('type') is-invalid @enderror" id="type" placeholder="Admin Type" readonly="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="email" value="{{ old('email', isset($admin)?$admin->email:null) }}" type="email" class="form-control form-control-line @error('email') is-invalid @enderror" id="email" placeholder="Email" readonly>
                                        @error('email')
                                        <div class="pl-1 text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input  name="password"  type="password" class="form-control form-control-line @error('password') is-invalid @enderror" id="password" placeholder="Password">
                                        @error('password')
                                        <div class="pl-1 text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @endphp--}}
                                    <label for="access" class="col-lg-2 col-sm-2 control-label"><strong>Operator Access</strong></label>
